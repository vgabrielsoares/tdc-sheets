...
-- Correct foreign keys for user_authority
ALTER TABLE "user_authority" ADD FOREIGN KEY ("user_id") REFERENCES "user" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "user_authority" ADD FOREIGN KEY ("authority_id") REFERENCES "authorities" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE "caracteristicas_arquetipos" ADD FOREIGN KEY ("arquetipo_id") REFERENCES "arquetipo" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- Índices para compartilhamento_ficha
...
ALTER TABLE "feiticos_personagem_habilidades_personagem" ADD FOREIGN KEY ("feiticos_personagem_habilidade") REFERENCES "feiticos_personagem" ("id");
...
ALTER TABLE "habilidades_origem" ADD FOREIGN KEY ("habilidade_id") REFERENCES "habilidade" ("id");
...
-- Foreign key para caracteristica_arquetipo
ALTER TABLE "caracteristica_arquetipo" ADD FOREIGN KEY ("arquetipo_id") REFERENCES "arquetipo" ("id") ON DELETE CASCADE;
...
ALTER TABLE "requisitos_talentos_poderes" ADD FOREIGN KEY ("habilidade_id") REFERENCES "habilidade" ("id");

ALTER TABLE "atributos_origem" ADD FOREIGN KEY ("origem_id") REFERENCES "origem" ("id");

-- Foreign key para origem_custom
ALTER TABLE "origem_custom" ADD FOREIGN KEY ("ficha_personagem_id") REFERENCES "ficha_personagem" ("id") ON DELETE CASCADE;
...
COMMENT ON COLUMN "ficha_personagem"."version" IS 'Controle de versionamento da ficha';
